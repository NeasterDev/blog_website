...
export default class BlogPost extends React.Component {
    ...
    saveBlogPost = (e) => {
        ...
        .then(res => {
            if (res.ok) { // if the save was successful, respond in the console
    ...
    render() {
        return (
            <div >
                <h2 className="h2 mt-2"><strong>Create new post</strong></h2>
                <label htmlFor="name" className='form-label'>Title: </label>
                <input className='form-control w-25 mx-auto' onChange={this.onTitleChange} type="text" name="title" /><br/>

                <label htmlFor="content" className='form-label'>Content: </label>
                <textarea className='form-control w-50 mx-auto' onChange={this.onContentChange} name="content"/><br/>
